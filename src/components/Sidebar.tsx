...
export default function Sidebar({ activeView, setActiveView, jiraConnected }: SidebarProps) {
  ...
  return (
    <aside className="w-64 glass-panel border-r border-zinc-200 dark:border-white/5 flex flex-col h-full z-10 shrink-0 hidden md:flex">
      {/* Header Logo */}
      ...
      <nav className="flex-1 px-3 py-4 space-y-6 overflow-y-auto">
        ...
        <div className="space-y-1">
          <p className="px-3 text-[9px] font-bold text-zinc-500 dark:text-zinc-500 uppercase tracking-wider mb-2">WORKSPACES</p>
